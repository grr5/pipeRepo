...
@CucumberOptions(
        ...
        glue = "src\\test\\java\\stepDefinitions\\ServiceCategorySteps",
        plugin = {"com.cucumber.listener.ExtentCucumberFormatter:reports/report.html",
                "html:target/cucumber-reports",
                "json:target/cucumber-reports/Cucumber.json"},
        tags = {"@service_category_mandate"},
        dryRun = false,
        monochrome = true,

        strict = true
)
public class serviceCategoryRunner extends AbstractTestNGCucumberTests {
